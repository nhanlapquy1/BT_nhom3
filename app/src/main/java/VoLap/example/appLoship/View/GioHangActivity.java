...
public class GioHangActivity extends AppCompatActivity implements ValueEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageButtonTru.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                txtThanhTien.setText(Integer.toString(Integer.parseInt(txtDonGia.getText().toString())*Integer.parseInt(txtSoLuong.getText().toString())));
            }
        });
        ...
        bt_giohang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseReference.child("donhang").setValue(donHang);
            }
        });
    ...
    public void onDataChange(@NonNull DataSnapshot snapshot) {
        txtDonGia.setText(snapshot.child("banhmy").getValue().toString());
    }
